...
function submitData(e) {
  ...
  // We use the fetch() function to send a POST request to the /summarize endpoint. The fetch()        function returns the summariezd text
  const myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
  myHeaders.append("Authorization", "Bearer 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");
